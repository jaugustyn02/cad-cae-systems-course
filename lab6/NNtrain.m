...
function NNtrain(num_epoch)
arguments
    num_epoch {mustBeInteger, mustBePositive} = 1; 
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%a2=1; b2=1; c2=1; d2=1;
%a3=1; b3=1; c3=1; d3=1;
a1=0.343805; b1=-0.485843; c1=-0.550607; d1=0.214690;
a2=1.672311; b2=-1.484064; c2=5.705904; d2=-1.049379;
a3=3.106743; b3=2.682547; c3=22.145497; d3=-20.763756;
...
%print learned coeffs
if num_epoch ~= 1
    print_coeffs(1, a1, b1, c1, d1)
    print_coeffs(2, a2, b2, c2, d2)
    print_coeffs(3, a3, b3, c3, d3)
end
end

function print_coeffs(i, a, b, c, d)
    fprintf('a%d=%.6f; b%d=%.6f; c%d=%.6f; d%d=%.6f;\n', i, a, i, b, i, c, i, d);
end
